                ...
                <form>
                    <table border="0" style="width:880px;" cellspacing="0" cellpadding="0">
                        <tr height="45">
                            ...
                            <td><input type="text" value="" id="email" name="email" class="add_ipt" style="width:180px;"/>&nbsp; <font
                                    color="#ff4e00">${noNullemail}</font></td>
                        </tr>
                        <tr height="45">
                            <td align="right">验证码 &nbsp; &nbsp;</td>
                            <td><input type="text" value="" id="emailCode" name="emailCode" class="add_ipt" style="width:90px;"/>
