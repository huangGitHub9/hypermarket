...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="<c:url value='/WEB-INF/adminjsps/admin/css/category/list.css'/>">
  ...
  <body>
    ...
    <table align="center" border="1" cellpadding="0" cellspacing="0">
    	<caption class="captionAddOneLevel">
    	  <a style="font-size: 15px;" href="<c:url value='/WEB-INF/adminjsps/admin/category/add.jsp'/>">添加一级分类</a>
    	</caption>
    	<tr class="trTitle">
