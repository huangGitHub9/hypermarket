...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public List<Order> getMyHasPayedOrder(User user) {
        return userMapper.getMyHasPayedOrder(user.getId());
    }
    ...
    public void AddActiveCode(int id, String email) {
        try {
            ...
            // 设置邮件的内容
            message.setContent(
                    "<a href='http://localhost:80/user/doActive.action?activeCode="+activeCode
