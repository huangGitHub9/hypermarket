...
<div class="log_bg">
    ...
    <div class="regist">
            ...
            <form id="register" action="/user/register.action" method="post">
                <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
                    <tr height="50" valign="top">
                        <td width="95">&nbsp;</td>
                        <td>
                            <span class="fl" style="font-size:24px;color: orangered"><strong>注册</strong></span>
                            <span class="fr">已有商城账号，<a href="/user/loginA.action" style="color:#ff4e00;">我要登录</a></span>
                        </td>
                    </tr>
                    <tr height="50">
                        <td align="right"><font color="#ff4e00">*</font>昵称 &nbsp;</td>
                        <td><input type="text" value="" name="username" class="l_user" required/></td>
                    </tr>
                    <tr height="50">
                    ...
                    <tr height="50">
                        ...
                        <td><input type="text" value="" name="identityCode" class="l_user" pattern="(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)" title="请输入正确的身份证号" /></td>
                    </tr>
                    <tr height="50">
                        <td align="right">&nbsp;邮箱 &nbsp;</td>
                        <td><input type="text" value="" name="email" class="l_email" pattern="^\w+@\w+(\.\w+){1,2}$" title="请输入正确的邮箱" /></td>
                    </tr>
                    <tr height="50">
                        <td align="right">&nbsp;手机 &nbsp;</td>
                        <td><input type="text" value="" name="mobile" class="l_tel" pattern="^(1[34578])\d{9}$" title="请输入正确的手机" required/></td>
                    </tr>
                    <tr height="60">
                        <td>&nbsp;</td>
        ...
        <div id = "dialog" style="padding-left: 900px">
            <strong style="font-size: 14px;color: red">${error1}</strong></div>
    </div>
</div>
<!--End Login End-->
<!--Begin Footer Begin-->
