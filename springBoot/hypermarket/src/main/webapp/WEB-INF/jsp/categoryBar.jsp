                ...
                <li>
                    ...
                    <div class="zj">
                        <div class="zj_l">
                            ...
                            <div class="zj_l_c">
                                <h2>
                                    <a href="/main/getProductByType2.action?type2Id=${type2.id }">${type2.name}
                                    </a>
                                </h2>
                                    <%-----------------------------------type2结束-------------------------------------------%>
                                <c:forEach items="${type2.type3}" var="type3">
                                    <a href="/main/getProductByType3.action?type3Id=${type3.id }">${type3.name }</a>|
                                </c:forEach>
                                    <%-----------------------------------type3结束-------------------------------------------%>
                                </c:forEach>
                            </div>
...
<ul class="menu_r">
    ...
    <c:forEach items="${type1List }" var="type1" begin="0" end="7">
        <li><a href="/main/getProductByType1.action?type1Id=${type1.id }">${type1.name}</a></li>
    </c:forEach>
</ul>
