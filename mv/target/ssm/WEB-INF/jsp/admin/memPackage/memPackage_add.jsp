		...
		<div style="width:600px ; margin: auto;">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" action="<c:url value='/admin/memPackageAddA.action'/>" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control"  placeholder="套餐价格"
									name="memPackagePrice" value="">
							</div>
						</div>
						<div class="form-group">
